...
int main()
{
    ...
    // fstream file;
    // file.open("/home/implication/eclipse-workspace/SpringChallenge2022-main/MyBot/SpiderAttack/data.txt", ios::in);
...
/* attacker *////////////////////////////////////////////
        ...
        if(atk_m == GO_PLACE){
            if(atk.getPos() != startPos) { atk.Move(startPos, "go_place"); }
            else{
                atk_m = HUNT;
                atkPatrol = huntPos1;
